...
{
    class Demo009_CurvedPolyTriangleWithoutNormals : CPRuntimeDemo
    {
        private OutputMesh mesh;

        public string GetName() {
            return "CurvedPoly Triangle Without Normals";
        } 
        ...
        public void Test(ITestAssert testAssert) {
            ...
            testAssert.AssertEquals(mesh.GetNormals().Length, 0, "Mesh Normals");
        ...
        private void Execute() {
            ...
            this.mesh.SetupStructure(false, true, false, 0);
